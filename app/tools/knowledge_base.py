...
_MOCK_KB_ARTICLES: list[dict] = [
    {
        "id": "KB-001",
        "title": "Troubleshooting EU Region Latency",
        "category": "infrastructure",
        "excerpt": "Steps to diagnose and resolve latency spikes in the EU-WEST cluster …",
        "tags": ["latency", "eu", "infrastructure"],
    },
    {
        "id": "KB-002",
        "title": "Billing Reconciliation Process",
        "category": "billing",
        "excerpt": "How to reconcile invoice amounts with usage data and handle discrepancies …",
        "tags": ["billing", "invoices", "reconciliation"],
    },
    {
        "id": "KB-003",
        "title": "SSO Integration Guide (SAML & OIDC)",
        "category": "authentication",
        "excerpt": "Step-by-step guide for setting up SSO with SAML 2.0 or OpenID Connect …",
    ...
    },
    {
        ...
        "category": "data",
        "excerpt": "Optimise large data exports: pagination, streaming, and timeout configuration …",
        "tags": ["export", "data", "performance"],
    },
    {
        "id": "KB-005",
        "title": "Compliance Reporting — Field Reference",
        "category": "compliance",
        "excerpt": "Full field reference for SOC2 and ISO-27001 compliance reports …",
    ...
    },
    {
        ...
        "category": "operations",
        "excerpt": "Standard operating procedure for P1/P2 incidents including escalation paths …",
        "tags": ["incident", "runbook", "operations"],
    },
    {
        "id": "KB-007",
        "title": "Customer Escalation Handling Playbook",
        "category": "customer_success",
        "excerpt": "Best practices for managing and resolving customer escalations, SLA timelines …",
        "tags": ["escalation", "customer_success", "sla"],
    },
]
